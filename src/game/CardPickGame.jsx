...
export default function CardPickGame(){
    ...
    const [betValue, updateBet] = useState(0)
    ...
    function GameComp(){
        ...
        return(
            <div className="grid">
                ...
                <button className="rounded-xl text-white bg-indigo-700 p-2">Play Again</button>
            </div>
        )
    }
    ...
    return(
        <div className="grid md:grid-cols-2 m-2 border-zinc-800 border-1 rounded-2xl">
            ...
            <div className="grid md:grid-cols-2 gap-x-2 md:gap-x-4">
                ...
                <input type="number" name="betAmount" id="amnt" step={0.01} min={0.1} max={5.0} className="block indent-3  w-[75%] outline-0" defaultValue={0.1} onChange={(e) => updateBet(e.target.value)}/>
